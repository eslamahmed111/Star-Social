...
class UserPosts(generic.ListView):
    ...
    def get_queryset(self):
        try:
            ...
            print(self.post_user)# check this. it returns the username of the post_user object
...
class CreatePost(LoginRequiredMixin, SelectRelatedMixin, generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        self.object.user = self.request.user # injecting the user who create the post in the datacase
